...
class ProfileController extends Controller
{
    ...
    public function index()
    {
        ...
        if($sp == null){
            return redirect('shift-pattern')->with('toast_info', 'Please add your shift pattern');
        }
        $job = Job::where('userID', Auth::id())->first();
        if($job == null){
            return redirect('job/create')->with('toast_info', 'please add your job before going to your profile');
        }
